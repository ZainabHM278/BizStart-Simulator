...
<!-- Customize this list with your actual feature set -->
...
## Roadmap
- [ ] Add downloadable PDF export of generated business plans
- [ ] Support multiple currency and market presets
- [ ] Add AI-generated narrative summaries alongside the financial charts

<!-- Update with your actual next steps -->
